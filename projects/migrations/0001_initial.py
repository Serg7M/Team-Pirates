# Generated by Django 5.0.6 on 2024-05-25 06:25
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hackaton_place', models.CharField(blank=True, max_length=10, verbose_name='Занятое место в хакатоне')),
                ...
                ('hackaton', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='projects.hackaton', verbose_name='Хакатон')),
                ('tag', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='projects.tag', verbose_name='Тег проекта')),
                ('team', models.ManyToManyField(to='projects.team', verbose_name='Состав команды')),
